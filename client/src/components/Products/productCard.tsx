    ...
    return (
        <div className="bg-slate-300 shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-6 flex flex-col h-full justify-between gap-2">
                ...
                <div className="flex justify-evenly items-center gap-1 md:flex-col h-1/3">
                    {addToCart && <>
                    ...
                    <button className="bg-green-600 text-white p-2 rounded-lg w-2/4 md:w-3/4" onClick={addProduct}>Add to cart</button>
                    </>}
                </div>
            </div>
        </div>
